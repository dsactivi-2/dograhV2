...
```bash
curl -o setup_custom_domain.sh https://raw.githubusercontent.com/dsactivi-2/dograhV2/main/scripts/setup_custom_domain.sh && chmod +x setup_custom_domain.sh && sudo ./setup_custom_domain.sh
```
