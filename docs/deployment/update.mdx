...
the checkout has local changes, creates a local rollback tag, updates the selected
branch, updates submodules, validates the remote configuration, then rebuilds:
