...
```
```powershell Windows
Invoke-WebRequest -OutFile docker-compose.yaml https://raw.githubusercontent.com/dsactivi-2/dograhV2/main/docker-compose.yaml; Invoke-WebRequest -OutFile start_docker.ps1 https://raw.githubusercontent.com/dsactivi-2/dograhV2/main/scripts/start_docker.ps1; .\start_docker.ps1
```
</CodeGroup>
...
<CodeGroup>
```bash macOS/Linux
curl -o setup_local.sh https://raw.githubusercontent.com/dsactivi-2/dograhV2/main/scripts/setup_local.sh && chmod +x setup_local.sh && ./setup_local.sh
```
```powershell Windows
Invoke-WebRequest -OutFile setup_local.ps1 https://raw.githubusercontent.com/dsactivi-2/dograhV2/main/scripts/setup_local.ps1; .\setup_local.ps1
```
</CodeGroup>
...
```bash
curl -o setup_remote.sh https://raw.githubusercontent.com/dsactivi-2/dograhV2/main/scripts/setup_remote.sh && chmod +x setup_remote.sh && sudo ./setup_remote.sh
```
